...
function updateBackgroundImage(img) {
    // $("#bImg1").fadeOut(500, function () {
    //     $("#bImg2").css("background-image", "url('../images/" + img + "')");
    //     $("#bImg2").fadeIn(800, function () {
            
    //         //$("#bImg1").css("background-image", "url('../images/" + img + "')");
    //         // $("#bImg1").css("opacity", "1");
    //         //$("#bImg1").fadeIn(800);
    //     });
    // });
    ...
    $(".bgImages").fadeToggle(1000, function () { // 1 goes down; 2 comes up
        console.log("fadeToggle: done!")
        //$("#bImg1").css("background-image", "url('../images/" + img + "')");
        // $("#bImg1").fadeIn(800);
        console.log("Img1 fadeIn start");
        $("#bImg1").fadeIn(1000, function () {
            console.log("Img1 fadeIn end; set Img1 background");
            $("#bImg1").css("background-image", "url('../images/" + img + "')");
            console.log("Img2 fadeOut start");
            $("#bImg2").fadeOut(1000,console.log("Img2 fadeOut end"));
        });
        // $("#bImg1").css("opacity", "1");
    });
